                ...
                <ul class="nav">
                    <li class="nav-item nav-profile">
                        <a href="#" class="nav-link">
                            <div class="nav-profile-image">
                                <img src="https://cdn0.iconfinder.com/data/icons/avatar-78/128/12-512.png" alt="profile">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#page-layouts" aria-expanded="false" aria-controls="page-layouts">
                            ...
                            <i class="fa fa-sort-desc ml-5" aria-hidden="true"></i>
                        </a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#blog-layouts" aria-expanded="false" aria-controls="blog-layouts">
                            <span class="menu-title">Blog Info</span>
                            <i class="fa fa-sort-desc ml-5" aria-hidden="true"></i>
                        </a>
                        <div class="collapse" id="blog-layouts">
                            <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="apps">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="{{ route ('manage-test') }}">Test Manage</a></li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#sidebar-layouts" aria-expanded="false" aria-controls="sidebar-layouts">
                            ...
                            <i class="fa fa-sort-desc ml-5"></i>
                        </a>
